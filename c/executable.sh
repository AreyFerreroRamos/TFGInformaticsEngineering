...
# Description: This script runs the command that executes the section of the project made in SEES:lab that performs the nestedness assessment using c.
#	Input:
...
then
 ...
 nestedness_assessment.c ../input_files/count_Genus_all.tsv ../input_files/metadata.csv ../input_files/sp_code.txt "$1" "$2"
