...
# Description: This script runs the command that executes the section of the project made in SEES:lab that performs the nestedness assessment using the pypy3 interprester instead of the python3 one.
#	Input:
...
pypy3 nestedness_assessment.py ../input_files/count_Genus_all.tsv ../input_files/metadata.csv ../input_files/sp_code.txt "$1" "$2"
